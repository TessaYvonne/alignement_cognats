...
def test_letter_splitter_splits_word():
    assert split_word("ɲɟà", 1) == [{"letter": "ɲɟ", "is_consonant": True, "word": "à"},
                                     {"letter": "à", "is_consonant": False, "word": ""}]
    assert split_word("bw", 1) == [{"letter": "b", "is_consonant": True, "word": "w"},
                                   {"letter": "w", "is_consonant": True, "word": ""}]
    assert split_word("àw", 1) == [{"letter": "à", "is_consonant": False, "word": "w"},
                                    {"letter": "w", "is_consonant": True, "word": ""}]


def test_letter_splitter_rejects_unknown_letters():
    assert split_word("a$̀", 1) == [{"letter": "a", "is_consonant": False, "word": "$̀"},
                                    {"letter": "error", "is_consonant": False, "word": "$̀"}]


def test_letter_splitter_accepts_special_tokens():
    assert split_word("°à°w", 1) == [{"letter": "°à", "is_consonant": False, "word": "°w"},
                                      {"letter": "°w", "is_consonant": True, "word": ""}]
    assert split_word("*à*w", 1) == [{"letter": "*à", "is_consonant": False, "word": "*w"},
                                      {"letter": "*w", "is_consonant": True, "word": ""}]


line9_data = [{'line': '9.', 'FR': 'accoucher',
...
def test_split_words_in_a_excel_file():
    assert (split_words_in_a_file("line9.xlsx") ==
            line9_data)
