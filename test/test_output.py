...
from output import letters_to_output, word_to_output, word_to_csv
...
def test_swo_letter_data_is_correct():
    ...
    assert (letters_to_output(swo_data) ==
...
def test_word_to_output():
    ...
    assert word_to_output(data[0]) == [['9.', 'accoucher', '', '', '', '', '', '', '', '', '', '', '', ''],
...
def test_output_to_csv():
    expected =  ['"9.";"accoucher";"";"";"";"";"";"";"";"";"";"";"";""',
                 ...
                 '"";"shiwa";"b";"j";"à";"";"";"";"";"";"";"";"";""',
                 '"";"";"";"";"";"";"";"";"";"";"";"";"";""']
    assert word_to_csv(word_to_output(split_words_in_a_file('line9.csv')[0])) == expected
